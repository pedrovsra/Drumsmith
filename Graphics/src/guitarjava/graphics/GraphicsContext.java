 ...
 * @author brunojadami
 */
public class GraphicsContext extends Applet implements GraphicsInterface, Runnable
{
    ...
    public synchronized void addGraphicsUpdateEventListener(GraphicsUpdateListener listener)
    {
        listeners.add(listener);
    }

    public synchronized void removeGraphicsUpdateEventListener(GraphicsUpdateListener listener)
    {
